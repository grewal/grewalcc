...
BEGIN {
    ...
    require '/home/monty/src/grewalcc/third_party/openssl/openssl-3.3.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/monty/src/grewalcc/third_party/openssl/openssl-3.3.0/test/fips-and-base.cnf';
    shift;
